...
class Question extends Component {
  ...
  render() {
    const { question, answer, category, difficulty, answer_count, correct_answers } = this.props;
    return (
      <div className="Question-holder">
        <div className="Question">{question}</div>
        <div className="Question-status">
          <img className="category" src={`${category}.svg`}/>
          <div className="difficulty">Difficulty: {difficulty} ({correct_answers} / {answer_count} good answers)</div>
